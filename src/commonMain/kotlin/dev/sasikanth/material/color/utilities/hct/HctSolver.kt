...
object HctSolver {
  ...
  fun hueOf(linrgb: DoubleArray): Double {
    val scaledDiscount: DoubleArray = MathUtils.matrixMultiply(linrgb, SCALED_DISCOUNT_FROM_LINRGB)
  ...
  fun solveToInt(hueDegrees: Double, chroma: Double, lstar: Double): Int {
    ...
    val targetHueDegrees = MathUtils.sanitizeDegreesDouble(hueDegrees)
    val hueRadians: Double = targetHueDegrees / 180 * PI
