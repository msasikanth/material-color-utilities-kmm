...
package dev.sasikanth.material.color.utilities.blend

import dev.sasikanth.material.color.utilities.hct.Cam16
...
object Blend {
  ...
  fun harmonize(designColor: Int, sourceColor: Int): Int {
    ...
    val differenceDegrees: Double = MathUtils.differenceDegrees(fromHct.getHue(), toHct.getHue())
  ...
  fun hctHue(from: Int, to: Int, amount: Double): Int {
    ...
    val blended: Hct = Hct.from(ucsCam.hue, fromCam.chroma, ColorUtils.lstarFromArgb(from))
