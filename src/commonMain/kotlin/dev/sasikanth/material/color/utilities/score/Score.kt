 ...
 */
package dev.sasikanth.material.color.utilities.score
...
object Score {
  ...
  fun score(
    ...
    for (hue in 0..359) {
      ...
      for (i in hue - 14 until hue + 16) {
        val neighborHue: Int = MathUtils.sanitizeDegreesInt(i)
    ...
    for (hct in colorsHct) {
      ...
      val chromaScore: Double = (hct.getChroma() - TARGET_CHROMA) * chromaWeight
  ...
  private class ScoredHCT(hct: Hct, score: Double) {
    val hct: Hct
    val score: Double
