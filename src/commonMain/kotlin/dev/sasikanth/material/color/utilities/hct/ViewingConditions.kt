...
private constructor(
  ...
  companion object {
    ...
    fun make(
      ...
      val targetBackgroundLstar = max(0.1, backgroundLstar)
      ...
      val c: Double =
        if (f >= 0.9) MathUtils.lerp(0.59, 0.69, (f - 0.9) * 10.0) else MathUtils.lerp(0.525, 0.59, (f - 0.8) * 10.0)
      var d =
      ...
      val n: Double = ColorUtils.yFromLstar(targetBackgroundLstar) / whitePoint[1]
